...
pheno <- read.csv("C:/Users/gbloc/Desktop/PCDHG_Gila/Transcriptomic rna seq data/GSE113165/GSE113165 pheno.csv")
counts <- read.delim("C:/Users/gbloc/Desktop/PCDHG_Gila/Transcriptomic rna seq data/GSE113165/GSE113165_counts.txt")
