...
pheno <- read_excel("C:/Users/gbloc/Desktop/PCDHG_Gila/Transcriptomic rna seq data/GeneSMART/Data/GeneSMART_phenotypes.xlsx")
counts <- read.delim("C:/Users/gbloc/Desktop/PCDHG_Gila/Transcriptomic rna seq data/GeneSMART/Data/GeneSMART_counts.tsv")
